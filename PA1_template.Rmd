...
``` {r load_data, echo=TRUE, message=FALSE,comment=FALSE}
library("dplyr")
library(lubridate)
library(ggplot2)
...
``` {r histogram1, echo=TRUE, message=TRUE}
...
``` {r time_series, echo=TRUE, message=TRUE}
#
...
``` {r cleaned_data, echo=TRUE, message=FALSE}
...
``` {r weekday_vs_weekend, echo=TRUE, message=FALSE}
